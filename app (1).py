...
<div class="main-header">
    ...
    <p>Tác giả: Đinh Công Quý - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0949923634</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đinh Công Quý - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0949923634</div>", unsafe_allow_html=True)
